function info = process_lead_in(obj)
%
%
%
...
if s.is_big_endian(cur_seg_index)
...
% % % 
% % % flags = struct(...
% % %     'hasMetaData',      bitget(toc_mask,2),...
% % %     'kTocNewObjList',   bitget(toc_mask,3),...
% % %     'hasRawData',       bitget(toc_mask,4),...
% % %     'isInterleaved',    bitget(toc_mask,6),... %false, contiguous
% % %     'isBigEndian',      bitget(toc_mask,7),... %false, little-endian
% % %     'hasRawDaqMX',      bitget(toc_mask,8));
% % % toc
