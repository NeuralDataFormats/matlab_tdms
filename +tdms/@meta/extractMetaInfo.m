...
%-----------------------------------------------------------
raw_meta_obj.raw_obj__data_types        = raw_obj__idx_data(1,1:cur_obj_index);
%NOTE: Ignoring dimension - row 2, for now ...
raw_meta_obj.raw_obj__n_values_per_read = double(typecastC(raw_obj__idx_data(3:4,1:cur_obj_index),'uint64'))';
raw_meta_obj.raw_obj__n_bytes_per_read  = double(typecastC(raw_obj__idx_data(5:6,1:cur_obj_index),'uint64'))';
...
raw_meta_obj.prop__names       = prop__names(1:cur_prop_index);
raw_meta_obj.prop__values      = prop__values(1:cur_prop_index);
raw_meta_obj.prop__raw_obj_id  = prop__raw_obj_id(1:cur_prop_index);
raw_meta_obj.prop__types       = prop__types(1:cur_prop_index);
